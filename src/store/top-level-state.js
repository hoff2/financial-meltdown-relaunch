import t from "tcomb";
import CustomerDetailsData, {
  getDefaultCustomerDetails,
} from "../components/customer-details/customer-details-state";
import FinancedItemState, {
  getDefaultFinancedItem,
} from "../components/financed-items/financed-item-state";
